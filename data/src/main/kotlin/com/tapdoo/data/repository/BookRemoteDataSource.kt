...
class BookRemoteDataSource(private val ktorHttpService: KtorHttpService) : BookApi {
     ...
     *
     * @return A Result containing either a list of BookApiModel objects or an error.
     */
    override suspend fun getBooks(): Result<List<BookApiModel>> {
        return ktorHttpService.get<List<BookApiModel>>(BOOK_URL)
    }
